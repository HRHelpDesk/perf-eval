<?php
/**
 * Template Name: Perf-eval-new .000000001
 */
?>
...
<html>
    <head>
        <script src=<?php echo get_stylesheet_directory_uri();?>/perf-eval-newassets/js/include.js"></script>

        <link href=<?php echo get_stylesheet_directory_uri();?>/perf-eval-newassets/css/tabs.css" rel="stylesheet"/>
...
<script>
    $(function(){
      $("#epeHub").load("/wp-content/themes/thrive-theme-child/perf-eval-new/views/EPE.html"); 
    });
...
<div id="pickHub" include-html="views/pick-eval.html"></div>
...
<script src="<?php echo get_stylesheet_directory_uri();?>/perf-eval-new/assets/js/setupEmail.js"></script>
